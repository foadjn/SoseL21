...
public class StructureAspectDescriptor extends BaseStructureAspectDescriptor {
  ...
  /*package*/ final ConceptDescriptor myConceptControlStatement = createDescriptorForControlStatement();
  ...
  /*package*/ final ConceptDescriptor myConceptFunctionStatement = createDescriptorForFunctionStatement();
  ...
  public Collection<ConceptDescriptor> getDescriptors() {
    return Arrays.asList(myConceptBinaryArithmeticExpression, myConceptBinaryComparisonExpression, myConceptBinaryExpression, myConceptBoolean, myConceptClass, myConceptControlStatement, myConceptDivExpression, myConceptElifStatement, myConceptElseStatement, myConceptEqualsExpression, myConceptExpressionStatement, myConceptForStatement, myConceptFunctionStatement, myConceptGreaterEqualExp, myConceptGreaterExpression, myConceptIExpression, myConceptIStatement, myConceptIfStatement, myConceptInteger, myConceptLessEqualExp, myConceptLessExpression, myConceptMinusExpression, myConceptMulExpression, myConceptNotEqualExpression, myConceptParameter, myConceptPlusExpression, myConceptReference, myConceptSoSeWorksheet, myConceptStringLiteral, myConceptVariable, myConceptVariableDeclaration, myConceptWhileStatement);
  }
  ...
  public ConceptDescriptor getDescriptor(SConceptId id) {
    switch (myIndexSwitch.index(id)) {
      ...
      case LanguageConceptSwitch.ControlStatement:
        return myConceptControlStatement;
      ...
      case LanguageConceptSwitch.FunctionStatement:
        return myConceptFunctionStatement;
  ...
  private static ConceptDescriptor createDescriptorForBoolean() {
    ...
    b.super_("SoseL21.structure.Variable", 0xf54c6703341840bcL, 0xbe9312879578d6a1L, 0x70df1b60f34a4d82L);
  ...
  private static ConceptDescriptor createDescriptorForClass() {
    ConceptDescriptorBuilder2 b = new ConceptDescriptorBuilder2("SoseL21", "Class", 0xf54c6703341840bcL, 0xbe9312879578d6a1L, 0x1c5e00a4364801e5L);
    b.class_(false, false, false);
    b.parent(0xf54c6703341840bcL, 0xbe9312879578d6a1L, 0x782cac11e196585fL);
    b.origin("r:3feced63-76c9-43c3-bfaf-118107b568a7(SoseL21.structure)/2044071986158109157");
    b.version(2);
    b.aggregate("body", 0x1c5e00a436480555L).target(0xf54c6703341840bcL, 0xbe9312879578d6a1L, 0x782cac11e196585fL).optional(true).ordered(true).multiple(true).origin("2044071986158110037").done();
    b.alias("class");
    return b.create();
  }
  private static ConceptDescriptor createDescriptorForControlStatement() {
    ConceptDescriptorBuilder2 b = new ConceptDescriptorBuilder2("SoseL21", "ControlStatement", 0xf54c6703341840bcL, 0xbe9312879578d6a1L, 0x47cc45b015d41f0aL);
    b.class_(false, true, false);
    b.parent(0xf54c6703341840bcL, 0xbe9312879578d6a1L, 0x782cac11e196585fL);
    b.origin("r:3feced63-76c9-43c3-bfaf-118107b568a7(SoseL21.structure)/5173586694524641034");
    b.version(2);
    return b.create();
  }
  ...
  private static ConceptDescriptor createDescriptorForElifStatement() {
    ...
    b.class_(false, false, false);
    b.super_("SoseL21.structure.ControlStatement", 0xf54c6703341840bcL, 0xbe9312879578d6a1L, 0x47cc45b015d41f0aL);
    ...
    b.aggregate("exp1", 0x74a09ebffc8d2b88L).target(0xf54c6703341840bcL, 0xbe9312879578d6a1L, 0x782cac11e196585fL).optional(true).ordered(true).multiple(true).origin("8403891452086397832").done();
    b.aggregate("exp2", 0x74a09ebffc8d2b8cL).target(0xf54c6703341840bcL, 0xbe9312879578d6a1L, 0x782cac11e196585fL).optional(true).ordered(true).multiple(true).origin("8403891452086397836").done();
    return b.create();
  }
  private static ConceptDescriptor createDescriptorForElseStatement() {
    ...
    b.aggregate("true", 0x74a09ebffc8ccb68L).target(0xf54c6703341840bcL, 0xbe9312879578d6a1L, 0x782cac11e196585fL).optional(true).ordered(true).multiple(true).origin("8403891452086373224").done();
    b.aggregate("false", 0x74a09ebffc8ccb6bL).target(0xf54c6703341840bcL, 0xbe9312879578d6a1L, 0x782cac11e196585fL).optional(true).ordered(true).multiple(true).origin("8403891452086373227").done();
    return b.create();
  }
  ...
  private static ConceptDescriptor createDescriptorForForStatement() {
    ...
    b.aggregate("do", 0x74a09ebffc8edf05L).target(0xf54c6703341840bcL, 0xbe9312879578d6a1L, 0x782cac11e196585fL).optional(true).ordered(true).multiple(true).origin("8403891452086509317").done();
    return b.create();
  }
  private static ConceptDescriptor createDescriptorForFunctionStatement() {
    ConceptDescriptorBuilder2 b = new ConceptDescriptorBuilder2("SoseL21", "FunctionStatement", 0xf54c6703341840bcL, 0xbe9312879578d6a1L, 0x74a09ebffc95860bL);
    b.class_(false, false, false);
    b.parent(0xf54c6703341840bcL, 0xbe9312879578d6a1L, 0x782cac11e196585fL);
    b.origin("r:3feced63-76c9-43c3-bfaf-118107b568a7(SoseL21.structure)/8403891452086945291");
    b.version(2);
    b.aggregate("param", 0x74a09ebffc95860eL).target(0xf54c6703341840bcL, 0xbe9312879578d6a1L, 0x74a09ebffc9790ecL).optional(true).ordered(true).multiple(true).origin("8403891452086945294").done();
    b.aggregate("return_type", 0x74a09ebffc958610L).target(0xf54c6703341840bcL, 0xbe9312879578d6a1L, 0x70df1b60f34a4d82L).optional(false).ordered(true).multiple(false).origin("8403891452086945296").done();
    b.aggregate("body", 0x74a09ebffc958613L).target(0xf54c6703341840bcL, 0xbe9312879578d6a1L, 0x782cac11e196585fL).optional(true).ordered(true).multiple(true).origin("8403891452086945299").done();
    return b.create();
  }
  ...
  private static ConceptDescriptor createDescriptorForIfStatement() {
    ...
    b.aggregate("statements", 0x74a09ebffc8b393eL).target(0xf54c6703341840bcL, 0xbe9312879578d6a1L, 0x782cac11e196585fL).optional(true).ordered(true).multiple(true).origin("8403891452086270270").done();
    return b.create();
  }
  ...
  private static ConceptDescriptor createDescriptorForParameter() {
    ConceptDescriptorBuilder2 b = new ConceptDescriptorBuilder2("SoseL21", "Parameter", 0xf54c6703341840bcL, 0xbe9312879578d6a1L, 0x74a09ebffc9790ecL);
    b.class_(false, false, false);
    b.parent(0xf54c6703341840bcL, 0xbe9312879578d6a1L, 0x58aeb4a19afd5f07L);
    b.origin("r:3feced63-76c9-43c3-bfaf-118107b568a7(SoseL21.structure)/8403891452087079148");
    b.version(2);
    b.aggregate("param", 0x74a09ebffc9790efL).target(0xf54c6703341840bcL, 0xbe9312879578d6a1L, 0x58aeb4a19afd5f07L).optional(false).ordered(true).multiple(false).origin("8403891452087079151").done();
    return b.create();
  }
  ...
  private static ConceptDescriptor createDescriptorForVariable() {
    ConceptDescriptorBuilder2 b = new ConceptDescriptorBuilder2("SoseL21", "Variable", 0xf54c6703341840bcL, 0xbe9312879578d6a1L, 0x70df1b60f34a4d82L);
    b.class_(false, true, false);
    b.parent(0xf54c6703341840bcL, 0xbe9312879578d6a1L, 0x58aeb4a19afd5f07L);
    b.origin("r:3feced63-76c9-43c3-bfaf-118107b568a7(SoseL21.structure)/8133249555266948482");
    b.version(2);
    return b.create();
  }
  ...
  private static ConceptDescriptor createDescriptorForWhileStatement() {
    ...
    b.aggregate("do", 0x74a09ebffc8e713eL).target(0xf54c6703341840bcL, 0xbe9312879578d6a1L, 0x782cac11e196585fL).optional(true).ordered(true).multiple(true).origin("8403891452086481214").done();
    return b.create();
  }
}
