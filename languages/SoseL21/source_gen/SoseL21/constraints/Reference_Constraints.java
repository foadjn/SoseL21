      ...
      public ReferenceScopeProvider getScopeProvider() {
        return new BaseScopeProvider() {
          ...
          public Scope createScope(final ReferenceConstraintsContext _context) {
            LoggingRuntime.logMsgView(Level.DEBUG, "contextnode.parent.index: " + SNodeOperations.getIndexInParent(SNodeOperations.getParent(_context.getContextNode())) + BaseConcept__BehaviorDescriptor.getDetailedPresentation_id22G2W3WJ92t.invoke(SNodeOperations.getParent(_context.getContextNode())), Reference_Constraints.class, null, null);
            LoggingRuntime.logMsgView(Level.DEBUG, "vardec : " + Sequence.fromIterable(SLinkOperations.collect(SNodeOperations.ofConcept(SLinkOperations.getChildren(SNodeOperations.getNodeAncestor(_context.getContextNode(), CONCEPTS.SoSeWorksheet$tb, false, false), LINKS.contents$adPM), CONCEPTS.VariableDeclaration$DC), LINKS.initializer$7vbT)).visitAll(new IVisitor<SNode>() {
              public void visit(SNode it) {
                return SNodeOperations.getIndexInParent(it);
              }
            }), Reference_Constraints.class, null, null);
