...
/*package*/ class Reference_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createEmpty_0() {
    ...
    editorCell.setCellId("Empty_d3lpcg_a0");
    return editorCell;
  }
  private EditorCell createRefCell_0() {
    final SReferenceLink referenceLink = LINKS.expression$Fe6m;
    SReferenceCellProvider provider = new SReferenceCellProvider(getNode(), referenceLink, getEditorContext()) {
      protected EditorCell createReferenceCell(final SNode targetNode) {
        ...
        }, targetNode, LINKS.expression$Fe6m);
    ...
    if (editorCell.getSRole() == null) {
      ...
      editorCell.setSRole(LINKS.expression$Fe6m);
    }
